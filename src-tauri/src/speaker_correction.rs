...
use crate::speaker::{SpeakerAttribution, SpeakerProfile, SpeakerTag};
...
fn candidates(segment: &TranscriptSegment) -> Vec<crate::speaker::SpeakerCandidate> {
    segment
        .speaker_attribution
        .as_ref()
...
mod tests {
    ...
    fn attribution(group_id: &str, anonymous_label: &str, state: &str) -> SpeakerAttribution {
        SpeakerAttribution {
            ...
            candidates: vec![crate::speaker::SpeakerCandidate {
