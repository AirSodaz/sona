 ...
 *
 * Roles are contracts from `[package.metadata.sona] role`. Workspace package
 * paths are also checked against the role roots below so layout and metadata
 * cannot drift apart.
 */
...
export const ROLE_DIRECTORY_ROOTS = new Map([
  ['core', 'core'],
...
export const HOST_CAPABILITY_MATRIX = [
  ...
  },
  {
    ...
    packages: ['sona-sherpa-onnx', 'sona-vad', 'sona-punct'],
