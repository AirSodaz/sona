...
如果您想查看面向终端用户的完整使用说明，请阅读[用户指南](docs/user-guide.zh-CN.md)。其中包含首次设置、`Live Record`、`Batch Import`、`工作区` / `项目` / `Inbox`、转录编辑、LLM 功能、导出、历史记录与常见问题。
...
### 离线转录
1.  进入 **Settings > Model Hub**（设置 > 模型中心）。
