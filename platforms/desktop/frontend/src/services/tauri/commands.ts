...
export const TauriCommand = {
  app: {
    ...
    deletePresetModel: 'delete_preset_model',
  ...
  recognizer: {
    prepareLive: 'prepare_live_transcription',
    createExternalSource: 'create_external_live_source',
    startExternalLive: 'start_external_live_transcription',
    feedExternalSource: 'feed_external_live_source',
    retireExternalSource: 'retire_external_live_source',
    startNativeLive: 'start_native_live_transcription',
    pauseNativeLive: 'pause_native_live_transcription',
    resumeNativeLive: 'resume_native_live_transcription',
    stopNativeLive: 'stop_native_live_transcription',
    ...
    testOnlineAsrProvider: 'test_online_asr_provider',
  },
  recovery: {
  ...
  sync: {
    ...
    discoverVaults: 'sync_discover_vaults',
    discoverWebDavVaults: 'sync_discover_webdav_vaults',
    getPairingInfo: 'sync_get_pairing_info',
