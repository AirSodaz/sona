...
import { DEFAULT_MODEL_RULES, modelService, PRESET_MODELS } from '../modelService';

test('ModelService benchmark', async ({ bench }) => {
  await bench('getModelRules - original', () => {
  ...
  await bench('getModelRules - optimized Map (current implementation)', () => {
