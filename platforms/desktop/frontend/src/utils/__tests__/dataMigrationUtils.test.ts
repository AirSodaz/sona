...
describe('convertOldFormatToLexical', () => {
  ...
  it('converts <i> to <em> and wraps in <p>', () => {
    expect(convertOldFormatToLexical('Hello <i>World</i>')).toBe('<p>Hello <em>World</em></p>');
  });

  it('preserves <u> tags and wraps in <p>', () => {
    expect(convertOldFormatToLexical('Hello <u>World</u>')).toBe('<p>Hello <u>World</u></p>');
  });
  ...
  it('wraps <em> text in <p>', () => {
    expect(convertOldFormatToLexical('<em>Italic text</em>')).toBe('<p><em>Italic text</em></p>');
  });
