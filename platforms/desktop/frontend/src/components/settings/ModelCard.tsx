  ...
  return (
    <div className="model-card">
      <div
        ...
        style={{ alignItems: 'flex-start', marginBottom: isMultiVersion ? '16px' : '0' }}
      >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            {((baseModel.modes && baseModel.modes.length > 0) || !!baseModel.engine) && (
              <div className="model-tags" style={{ marginTop: '0' }}>
                ...
                {baseModel.isRecommended && (
                  <span className="model-tag">{t('common.recommended')}</span>
                )}
              </div>
            )}
          </div>
        ...
        <div className="progress-container-mini">
          <div className="progress-info-mini" aria-live="polite">
            <span style={{ color: 'var(--color-text-muted)', fontSize: '0.75rem' }}>
              {downloads[baseModel.id].status || t('common.loading')}
            </span>
          ...
          >
            <div
              ...
              style={{ width: `${downloads[baseModel.id].progress}%` }}
            />
          </div>
        </div>
      )}
                ...
                >
                  ...
                  {isDownloading && (
                    <div className="progress-container-mini" style={{ marginTop: 0 }}>
                      <div className="progress-info-mini" aria-live="polite">
                        <span style={{ color: 'var(--color-text-muted)', fontSize: '0.75rem' }}>
                          {downloadState.status || t('common.loading')}
                        </span>
