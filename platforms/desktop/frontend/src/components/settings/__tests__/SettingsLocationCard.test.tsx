...
describe('SettingsLocationCard', () => {
  ...
  it('renders ready status badge when isValid is true', () => {
    render(<SettingsLocationCard title="FFmpeg Path" path="/usr/bin/ffmpeg" isValid={true} />);
  ...
  it('renders not found status badge when isValid is false', () => {
    render(
      <SettingsLocationCard title="FFmpeg Path" path="/usr/bin/missing_ffmpeg" isValid={false} />
    );
  ...
  it('disables open folder button when path is empty or isBusy is true', () => {
    ...
    const { rerender } = render(
      <SettingsLocationCard title="Storage Location" path="" onOpenFolder={onOpenFolder} />
    );
