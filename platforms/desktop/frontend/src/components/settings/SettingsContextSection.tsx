...
export function SettingsContextSection(): React.JSX.Element {
  ...
  const presetOptions = useMemo(() => getPolishPresetOptions(customPresets, t), [customPresets, t]);
  ...
  const handleDeletePreset = async (presetId: string) => {
    ...
    const nextPresetId =
      config.polishPresetId === presetId
        ? DEFAULT_POLISH_PRESET_ID
    ...
    <>
      ...
      <SettingsSection
        ...
        description={t('settings.context_builtin_description', {
          defaultValue:
            'These presets are provided by Sona and can be viewed here, but not edited.',
        })}
        icon={<FileTextIcon width={20} height={20} />}
      >
          ...
          >
            ...
            <div
              style={{
                ...
                color: preset.context ? 'var(--color-text-primary)' : 'var(--color-text-muted)',
                fontSize: '0.875rem',
                lineHeight: 1.5,
                whiteSpace: 'pre-wrap',
              }}
      ...
      <SettingsSection
        ...
        description={t('settings.context_custom_description', {
          defaultValue:
            'Create reusable name + context pairs and switch between them from text polish or project settings.',
        })}
        icon={<FileTextIcon width={20} height={20} />}
      >
        <div
        ...
        >
          ...
          <textarea
            ...
            placeholder={t('settings.context_placeholder', {
              defaultValue: 'Enter preset context...',
            })}
            ...
            >
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                <input
                  ...
                  aria-label={t('settings.context_name_placeholder', {
