import { FilePenLine, Mic, Play, Search } from 'lucide-react';
import React from 'react';
import { useTranslation } from 'react-i18next';
import { useSetConfig, useShortcutConfig } from '../../stores/configStore';
  ...
  const sections: ShortcutSection[] = [
      ...
      items: [
        {
          ...
          key: config.liveRecordShortcut || 'Ctrl + Space',
          description: t('shortcuts.record_start_stop'),
          editable: true,
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          key: '← / →',
          description: `${t('shortcuts.seek_backward')} / ${t('shortcuts.seek_forward')}`,
        },
        {
          key: '↑ / ↓',
          description: `${t('shortcuts.volume_up')} / ${t('shortcuts.volume_down')}`,
        },
    ...
    },
    {
      ...
      items: [
        {
          key: 'Ctrl + F',
          description: t('shortcuts.find_current_context', {
            defaultValue: 'Find in current context',
          }),
        },
        {
          key: 'Enter / Shift + Enter',
          description: t('shortcuts.next_prev_transcript_match', {
            defaultValue: 'Next / previous transcript match',
          }),
        },
        {
          key: '↑ / ↓',
          description: t('shortcuts.navigate_workspace_results', {
            defaultValue: 'Navigate workspace search results',
          }),
        },
        {
          key: 'Esc',
          description: t('shortcuts.clear_or_close_search', {
            defaultValue: 'Clear or close current search',
          }),
        },
      ],
    },
