...
import { formatChannelBadgeLabel, getAppReleaseChannel } from '../../utils/channel';
      ...
      case 'downloaded':
        return (
          <div className="update-status success">
            ...
            <button className="btn btn-primary btn-sm" onClick={relaunchToUpdate}>
  ...
  return (
    ...
    >
      ...
      <div className="about-header">
        ...
        <p className="about-description">{t('settings.about_desc')}</p>
      </div>
      ...
      {/* Actions */}
      <div className="about-actions">{renderUpdateContent()}</div>
