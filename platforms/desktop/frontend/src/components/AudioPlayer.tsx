...
import { MuteIcon, PauseIcon, PlayFilledIcon, VolumeIcon } from './Icons';
...
export function AudioPlayer({ className = '' }: AudioPlayerProps): React.JSX.Element | null {
  ...
  const { volume, isMuted, handleVolumeChange, toggleMute, setVolume } = useAudioVolume(audioRef);
  ...
  return (
    <div className={`audio-player ${className}`}>
      ...
      <div className="audio-timeline">
        <TimeDisplay />
        <SeekSlider duration={duration} onSeek={requestSeek} seekLabel={t('player.seek')} />
