...
export function ColorPicker({ isOpen, color, onChange, onClose, onPickingChange, anchorRef }: ColorPickerProps): React.JSX.Element | null {
    ...
    const updateBoardCoords = useCallback((clientX: number, clientY: number) => {
    ...
    const updateHueCoords = useCallback((clientX: number) => {
        ...
        <ModalPortal>
            ...
            >
                    ...
                    {format === 'rgb' ? (
                        <div style={{ display: 'flex', gap: '6px', flex: 1 }}>
                            {(['r', 'g', 'b'] as const).map((channel) => (
                                <div key={channel} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1, gap: '2px' }}>
                                    <input
                                        type="number"
                                        min={0}
                                        max={255}
                                    ...
                                    />
                                    <span style={{ fontSize: '0.6875rem', color: 'var(--color-text-muted)', textTransform: 'uppercase', fontWeight: 600 }}>
                                        {channel}
                                    </span>
                                </div>
                            ))}
                ...
                <input
                    ...
                    type="color"
                    style={{ position: 'absolute', opacity: 0, pointerEvents: 'none', width: 0, height: 0, border: 0, padding: 0 }}
