...
export function SegmentEditorContextMenuPlugin({
  ...
  const restoreEditor = useCallback(
    (selection: BaseSelection | null, action?: () => void): boolean => {
  ...
  const openMenu = useCallback(
    (anchor: HTMLElement, point: { x: number; y: number }, invocation: 'pointer' | 'keyboard') => {
      ...
      const actions: ContextMenuAction[] = [
        {
          ...
          label: t('common.cut'),
          icon: <Scissors />,
          shortcut: getEditorShortcut('cut'),
        ...
        },
        {
          ...
          icon: <ClipboardPaste />,
          shortcut: getEditorShortcut('paste'),
          disabled: !canRead,
          onSelect: paste,
        },
        {
        ...
        },
        {
          ...
          label: t('editor.bold'),
          icon: <BoldIcon />,
          shortcut: getEditorShortcut('bold'),
          dividerBefore: true,
          onSelect: () => format('bold'),
        },
        {
          id: 'italic',
          label: t('editor.italic'),
          icon: <ItalicIcon />,
          shortcut: getEditorShortcut('italic'),
          onSelect: () => format('italic'),
        },
        {
          id: 'underline',
          label: t('editor.underline'),
          icon: <UnderlineIcon />,
          shortcut: getEditorShortcut('underline'),
          onSelect: () => format('underline'),
        },
        {
          id: 'strikethrough',
          label: t('editor.strikethrough'),
          icon: <StrikethroughIcon />,
          shortcut: getEditorShortcut('strikethrough'),
          onSelect: () => format('strikethrough'),
        },
      ];
