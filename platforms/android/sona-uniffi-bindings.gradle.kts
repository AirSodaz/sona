...
val buildSonaUniffiAndroidLibraries = tasks.register<Exec>("buildSonaUniffiAndroidLibraries") {
    ...
    inputs.file(File(repoRoot, "platforms/uniffi/Cargo.toml"))
    inputs.dir(File(repoRoot, "platforms/uniffi/src"))
    inputs.file(File(repoRoot, "providers/asr/local/sherpa_onnx/Cargo.toml"))
    inputs.file(File(repoRoot, "providers/asr/local/sherpa_onnx/build.rs"))
    inputs.dir(File(repoRoot, "providers/asr/local/sherpa_onnx/src"))
