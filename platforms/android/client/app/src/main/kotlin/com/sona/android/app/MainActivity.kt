    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            SonaApp(
                ...
                onDiscoverSyncVaults = syncSettingsViewModel::discoverVaults,
                onCreateSyncWithVaultId = syncSettingsViewModel::create,
                onApplySyncPairingToken = syncSettingsViewModel::applyPairingToken,
                onClearSyncPairingNotice = syncSettingsViewModel::clearPairingNotice,
                onGetSyncPairingToken = syncSettingsViewModel::getPairingToken,
