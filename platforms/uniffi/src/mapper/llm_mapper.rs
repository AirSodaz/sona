...
pub fn llm_provider_strategy_to_ffi(strategy: LlmProviderStrategy) -> FfiLlmProviderStrategy {
    match strategy {
        ...
        LlmProviderStrategy::Baidu => FfiLlmProviderStrategy::Baidu,
        LlmProviderStrategy::Tencent => FfiLlmProviderStrategy::Tencent,
        LlmProviderStrategy::Stepfun => FfiLlmProviderStrategy::Stepfun,
        LlmProviderStrategy::Lingyiwanwu => FfiLlmProviderStrategy::Lingyiwanwu,
        LlmProviderStrategy::Cerebras => FfiLlmProviderStrategy::Cerebras,
...
fn llm_provider_strategy_from_ffi(strategy: FfiLlmProviderStrategy) -> LlmProviderStrategy {
    match strategy {
        ...
        FfiLlmProviderStrategy::Baidu => LlmProviderStrategy::Baidu,
        FfiLlmProviderStrategy::Tencent => LlmProviderStrategy::Tencent,
        FfiLlmProviderStrategy::Stepfun => LlmProviderStrategy::Stepfun,
        FfiLlmProviderStrategy::Lingyiwanwu => LlmProviderStrategy::Lingyiwanwu,
        FfiLlmProviderStrategy::Cerebras => LlmProviderStrategy::Cerebras,
