...
pub struct FfiTaskLedgerPatchV1 {
    ...
    pub tag_automation_rule_id: FfiStringPatchV1,
    pub automation_profile_id: FfiStringPatchV1,
    pub automation_profile_source: FfiStringPatchV1,
...
impl From<FfiTaskLedgerRecordV1> for TaskLedgerRecord {
    fn from(value: FfiTaskLedgerRecordV1) -> Self {
        Self {
            ...
            tag_automation_rule_id: value.tag_automation_rule_id,
            automation_profile_id: value.automation_profile_id,
            automation_profile_source: value.automation_profile_source,
...
impl From<FfiTaskLedgerPatchV1> for TaskLedgerPatch {
    fn from(value: FfiTaskLedgerPatchV1) -> Self {
        Self {
            ...
            tag_automation_rule_id: value.tag_automation_rule_id.into_core(),
            automation_profile_id: value.automation_profile_id.into_core(),
            automation_profile_source: value.automation_profile_source.into_core(),
